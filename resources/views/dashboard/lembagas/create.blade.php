<x-dash-layout>
    ...
    <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16 sm:ml-64">
        <form action="/dashboard/lembagas" method="POST">
            @csrf
            ...
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="no_statistik" id="no_statistik"
                        ...
                        placeholder="Contoh: 121113080001" required autofocus value="{{ old('no_statistik') }}">
                    @error('no_statistik')
                ...
                <div>
                    ...
                    <input type="text" name="npsn" id="npsn"
                        ...
                        dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white
                        dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        placeholder="Contoh: 10311287" autofocus value="{{ old('npsn') }}">
                    @error('npsn')
                        <div class="invalid-feedback text-red-600 text-sm mt-1">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="nama_lembaga" id="nama_lembaga"
                        ...
                        dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white
                        dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        placeholder="contoh: MTsN 1 Pasaman" required value="{{ old('nama_lembaga') }}">
                    @error('nama_lembaga')
                        <div class="invalid-feedback text-red-600 text-sm mt-1">{{ $message }}</div>
                    @enderror
                </div>
                    ...
                    <div class="grid gap-4 sm:grid-cols-3">
                        ...
                        <div>
                            <input type="number" name="jumlah_guru" id="jumlah_guru" min="0"
                                ...
                                dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white
                                dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Guru" value="{{ old('jumlah_guru') }}">
                            @error('jumlah_guru')
                                <div class="invalid-feedback text-red-600 text-sm mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div>
                            <input type="number" name="jumlah_siswa" id="jumlah_siswa" min="0"
                                ...
                                dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white
                                dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Siswa" value="{{ old('jumlah_siswa') }}">
                            @error('jumlah_siswa')
                                <div class="invalid-feedback text-red-600 text-sm mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div>
                            <input type="number" name="jumlah_rombel" id="jumlah_rombel" min="0"
                                ...
                                dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white
                                dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Rombel" value="{{ old('jumlah_rombel') }}">
                            @error('jumlah_rombel')
                                <div class="invalid-feedback text-red-600 text-sm mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="sm:col-span-2">
                    ...
                    <select id="kecamatan" name="kecamatan"
                        ...
                        <option value="Bonjol" @selected(old('kecamatan') == 'Bonjol')>Bonjol</option>
                        <option value="Duo Koto" @selected(old('kecamatan') == 'Duo Koto')>Duo Koto</option>
                        <option value="Panti" @selected(old('kecamatan') == 'Panti')>Panti</option>
                        <option value="Mapat Tunggul" @selected(old('kecamatan') == 'Mapat Tunggul')>Mapat Tunggul</option>
                        <option value="Mapat Tunggul Selatan" @selected(old('kecamatan') == 'Mapat Tunggul Selatan')>Mapat Tunggul Selatan
                        </option>
                        <option value="Padang Gelugur" @selected(old('kecamatan') == 'Padang Gelugur')>Padang Gelugur</option>
                        <option value="Rao" @selected(old('kecamatan') == 'Rao')>Rao</option>
                        <option value="Rao Selatan" @selected(old('kecamatan') == 'Rao Selatan')>Rao Selatan</option>
                        <option value="Rao Utara" @selected(old('kecamatan') == 'Rao Utara')>Rao Utara</option>
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="url" name="map_embed_url" id="map_embed_url"
                        ...
                        dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white
                        dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        placeholder="https://www.google.com/maps/embed?pb=..." value="{{ old('map_embed_url') }}">
                    @error('map_embed_url')
                        <div class="invalid-feedback text-red-600 text-sm mt-1">{{ $message }}</div>
                    @enderror
                ...
                <div>
                    ...
                    <input type="text" name="latitude" id="latitude" inputmode="decimal"
                        ...
                        dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white
                        dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        placeholder="-0.05480612" value="{{ old('latitude') }}">
                    @error('latitude')
                        <div class="invalid-feedback text-red-600 text-sm mt-1">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="longitude" id="longitude" inputmode="decimal"
                        ...
                        dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white
                        dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        placeholder="100.20053275" value="{{ old('longitude') }}">
                    @error('longitude')
                        <div class="invalid-feedback text-red-600 text-sm mt-1">{{ $message }}</div>
                    @enderror
                </div>
