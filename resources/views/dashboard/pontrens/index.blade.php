        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    ...
                    <form class="flex items-center">
                        ...
                        <div class="relative w-full">
                            ...
                            <input
                                ...
                                type="search" id="search" name="search" placeholder="Search pontren"
                                autocomplete="off">
                        </div>
                    </form>
                </div>
                ...
                <div
                    ...
                    <a href="/dashboard/pontrens/create"
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            <th scope="col" class="px-4 py-3">pontren</th>
                            <th scope="col" class="px-4 py-3">Slug</th>
                            <th scope="col" class="px-4 py-3">Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($pontrens as $pontren)
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 flex items-center justify-end">
                                    @php
                                        $dropdownId = 'dropdown-' . $pontren->id;
                                    @endphp
                                    ...
                                    <div id="{{ $dropdownId }}"
                                        ...
                                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                            ...
                                            <li>
                                                <a href="/dashboard/pontrens/{{ $pontren->slug }}/edit"
                                        ...
                                        <div class="py-1">
                                            <form action="/dashboard/pontrens/{{ $pontren->slug }}" method="post">
                                                @method('delete')
                                                @csrf
