...
//     // contoh kalau pakai search
//     if ($request->search) {
//         $madrasahs->where('nama_lembaga', 'like', '%' . $request->search . '%');
//     }

//     $madrasahs = $madrasahs->orderBy('nama_lembaga')->paginate(10)->withQueryString();

//     return view('madrasah.index', [
//         'title' => 'Daftar Madrasah',
//         'madrasahs' => $madrasahs,
//     ]);
// }
